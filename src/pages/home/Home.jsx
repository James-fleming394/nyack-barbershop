...
const Home = () => {
  ...
  useEffect(() => {
    // Delay Google Map and Elfsight widget to avoid ResizeObserver layout thrashing
    const mapTimer = setTimeout(() => setShowMap(true), 150);
    const elfsightTimer = setTimeout(() => setShowElfsight(true), 300);
    return () => {
      clearTimeout(mapTimer);
      clearTimeout(elfsightTimer);
    };
  }, []);
